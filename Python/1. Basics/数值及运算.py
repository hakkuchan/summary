...
2. 数的进制
    ...
    · n进制表示用 n 个不同符号来表示数，
      例如十进制是用 0 ~ 9 个符号表示数字，二进制是用 0，1 两个符号表示数字。
    ...
    · 十进制转二进制：用十进制数不断除以 2，先得到的余数往后放，后得到的余数往前放，排列出的就是二进制数，
      例如：十进制数 4，先除以2，商2余0；2再除以2，商1余0；1再除以2，商0余1，所以二进制数为 100，
      十进制转其它进制的方法以此类推。
"""
