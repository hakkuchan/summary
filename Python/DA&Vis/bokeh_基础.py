...
""" 1. 绘图流程：
    ...
    · Step 2：生成画布
    ↓
    · Step 3：绘图：图尺寸、设置工具栏、坐标轴名称及范围、图名称
    ↓
    · Step 4：显示
"""
...
''' Step 2: 生成画布 '''
p = figure(plot_width=600, plot_height=400,         # 图宽度、高度
...
p.circle(df['A'], df['B'], size=20,  alpha=0.5)
p.title.text_color = "white"            # 标题字体颜色
p.title.text_font = "times"             # 标题字体
p.title.text_font_style = "italic"      # 标题字体风格
p.title.background_fill_color = "blue"  # 标题背景颜色
show(p)
