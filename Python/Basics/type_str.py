""" · 目录
    ...
    |—— 2. 字符串操作
        |
        |—— 2.1 通用操作：索引&切片、拼接、成员、内置函数
        |
        |—— 2.2 特殊操作：大小写、删除空格、对齐、替换、分割、合并、类型判断、原始字符串
        |
        |—— 2.3 eval()函数 ：把字符串转换为对象、把字符串转换为表达式
"""
...
''' 2.2 特殊操作（字符串是不可变类型，下面的所有操作，都是生成了新字符串，而非改变源字符串）'''
# 大小写
